...
INSERT INTO role_entity (id, role_name) VALUES (4, 'ROLE_COURIER') ON CONFLICT DO NOTHING;

ALTER SEQUENCE roles_sequence RESTART WITH 5;
...
INSERT INTO authority (id, authority_name) VALUES (5, 'courier') ON CONFLICT DO NOTHING;
...
INSERT INTO role_authority (role_id, authority_id) VALUES (4, 5) ON CONFLICT DO NOTHING;
