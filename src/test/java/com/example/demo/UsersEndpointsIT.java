...
//        users.add(new User(3L, UUID.fromString("d4c1ca44-e996-4ed9-80c9-d5d0a1f4b2ff"), "admin", "$2a$12$TpOiIo8Th4AwND6vxCgs.e.QNOka.m4hux9hVH4iz1DxIiUBrHzXe", "Tom", "Doe", LocalDateTime.of(2022,7,13, 12, 0), LocalDateTime.of(2022,7,13, 12, 0), 3L, new Role(1L, "ROLE_ADMIN", List.of(new Authority(1L, "user:create"), new Authority(2L, "user:read"), new Authority(3L, "user:update"), new Authority(4L, "user:delete"))), true, true, true, true));
        ...
        userRoleToken = jwtTokenProvider.refreshAccessToken(new User(1L, UUID.fromString("d51f1234-3d7d-4100-8846-468f38e14a4f"), "johnd", "$2a$12$L61SNM2qG1YPyD4.bG02OOUBO.oW8QOT51CwMlgQ/7HibB8bhXXuO", "John", "Doe", LocalDateTime.of(2022,7,13, 12, 0), LocalDateTime.of(2022,7,13, 12, 0), 1L, new Role(1L, "ROLE_USER", List.of(new Authority(2L, "user:read"))), true, true, true, true), userRoleToken);
        ...
        managerRoleToken = jwtTokenProvider.refreshAccessToken(new User(2L, UUID.fromString("07db1b55-714b-432e-af3b-5ad587a359e0"), "janed", "$2a$12$JVpKQOwi6gxeVlp6oUWlQuObzeyM8SFfWJtCxTOIJgn/TT4PCTle6", "Jane", "Doe", LocalDateTime.of(2022,7,13, 12, 0), LocalDateTime.of(2022,7,13, 12, 0), 2L, new Role(1L, "ROLE_MANAGER", List.of(new Authority(2L, "user:read"), new Authority(3L, "user:update"))), true, true, true, true), managerRoleToken);
        ...
        adminRoleToken = jwtTokenProvider.refreshAccessToken(new User(3L, UUID.fromString("d4c1ca44-e996-4ed9-80c9-d5d0a1f4b2ff"), "admin", "$2a$12$TpOiIo8Th4AwND6vxCgs.e.QNOka.m4hux9hVH4iz1DxIiUBrHzXe", "Tom", "Doe", LocalDateTime.of(2022,7,13, 12, 0), LocalDateTime.of(2022,7,13, 12, 0), 3L, new Role(1L, "ROLE_ADMIN", List.of(new Authority(1L, "user:create"), new Authority(2L, "user:read"), new Authority(3L, "user:update"), new Authority(4L, "user:delete"))), true, true, true, true), adminRoleToken);
    }
